...
# 开发时间: 2026-07-08
# 文件名: config.py
# 功能说明: 集中管理四轴无人机能耗预测实验3.0的路径、参数和输出文件名
# 版本号：3.0
...
SECOND_ENERGY_CSV = PROCESSED_DIR / "second_energy_3.0.csv"
EXCLUDED_ROUTES_CSV = PROCESSED_DIR / "excluded_routes_3.0.csv"
...
BEST_MODEL_FILE = SAVE_DIR / "best_energy_tcn_rls_3.0.pt"
FINAL_MODEL_FILE = SAVE_DIR / "final_energy_tcn_rls_3.0.pt"
...
VISUALIZATION_SUMMARY_JSON = OUT_DIR / "visualization_summary_3.0.json"
TERMINAL_LOG_FILE = LOG_DIR / "terminal_3.0.log"
...
def build_config(**overrides: object) -> ExperimentConfig:
    ...
    if "save_dir" in normalized:
        ...
        normalized.setdefault("best_model_file", save_dir / "best_energy_tcn_rls_3.0.pt")
        normalized.setdefault("final_model_file", save_dir / "final_energy_tcn_rls_3.0.pt")
    if "out_dir" in normalized:
        ...
        normalized.setdefault("excluded_routes_csv", processed_dir / "excluded_routes_3.0.csv")
        ...
        normalized.setdefault("terminal_log_file", log_dir / "terminal_3.0.log")
        normalized.setdefault("custom_prediction_summary_json", custom_dir / "custom_prediction_summary_3.0.json")
