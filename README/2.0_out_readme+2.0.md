...
![时间窗口候选比较](./assets/2.0/training/candidate_validation_wape.png)

![超参数排序](./assets/2.0/training/hyperparameter_ranking.png)
...
![总体评估指标](./assets/2.0/results/evaluation_metrics.png)
...
![训练损失曲线](./assets/2.0/training/loss_curve_2.0.png)

![学习率变化](./assets/2.0/training/learning_rate_schedule.png)

![最终损失曲线](./assets/2.0/training/loss_curve_2.0.png)
...
![功率区间 MAE](./assets/2.0/results/power_bin_mae.png)

![功率预测散点图](./assets/2.0/prediction/power_prediction_scatter.png)

![功率残差分布](./assets/2.0/prediction/power_residual_histogram.png)
...
![flight 能耗真实值与预测值](./assets/2.0/results/flight_energy_actual_vs_predicted.png)

![flight 能耗误差](./assets/2.0/results/flight_energy_error.png)

![flight 8 功率时序](./assets/2.0/prediction/flight_8_power_timeseries.png)

![flight 76 功率时序](./assets/2.0/prediction/flight_76_power_timeseries.png)

![flight 80 功率时序](./assets/2.0/prediction/flight_80_power_timeseries.png)
...
![自定义工况功率](./assets/2.0/custom/custom_power_timeseries.png)

![自定义工况累计能耗](./assets/2.0/custom/custom_cumulative_energy.png)
